...
# Generate the start and debug script for RunPod
echo "Copy this script to your RunPod container:"
echo ""
cat << 'EOF'
cat > start_and_debug.sh << 'SCRIPT_EOF'
#!/bin/bash
...
echo "✅ Start and debug script created!"
EOF
