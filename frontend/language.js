...
const translations = {
    en: {
        ...
        gpuRequirement: 'GPU: NVIDIA with ≥80GB VRAM for 20B model (FP16 for learning)',
        portRequirement: 'Port: 8001 must be accessible (configure firewall/NAT)',
        diskRequirement: 'Disk: ≥25-40GB free space for model weights',
    ...
    ko: {
        ...
        quickStartNode: '빠른 시작',
        oneClickNodeSetup: 'API 키를 받고 몇 초 안에 컴퓨팅 파워 기여를 시작하세요:',
        generateNodeKey: '노드 키 생성',
        getSetupCommands: '설정 명령어 받기',
        ...
        gpuRequirement: 'GPU: NVIDIA GPU (20B 모델 학습용 80GB+ VRAM, FP16)',
        ...
        portRequirement: '포트: 8001번 포트 접근 가능 (방화벽/NAT 설정)',
        diskRequirement: '디스크: 모델 가중치용 25-40GB 여유 공간',
